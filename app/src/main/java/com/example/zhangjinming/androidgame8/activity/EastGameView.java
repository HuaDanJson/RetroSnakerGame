...
public class EastGameView extends SurfaceView implements SurfaceHolder.Callback, Runnable {
    ...
    private Block head;
    private static DBScoreBean mDBScoreBean;

    public EastGameView(Context context, SurfaceHolder holder) {
        super(context);
        init(context);
    }

    public EastGameView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public EastGameView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        food.setY(head.getX());
    ...
    public void run() {
        while (isRun) {
            ...
            if (diffTime < 1000 / 60) {
                try {
                    Thread.sleep(20000 / 60 - diffTime);
